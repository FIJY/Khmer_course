...
export default function Vocab() {
  ...
  const fetchVocab = async () => {
    try {
      ...
      // Загружаем список всех слов, которые есть в SRS (значит, мы их уже учили)
  ...
  return (
    <div className="min-h-screen bg-black text-white pb-32 font-sans">
      ...
      <div className="px-6 mt-6 space-y-3">
        {loading ? (
          <div className="text-center text-gray-500 py-10 animate-pulse text-xs font-bold tracking-widest uppercase">Syncing Library...</div>
