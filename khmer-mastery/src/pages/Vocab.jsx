...
export default function Vocab() {
  ...
  const fetchAllWords = async () => {
    try {
      // Подтягиваем только колонку vocabulary из всех уроков
      ...
      // Объединяем массивы слов из всех уроков в один плоский список
      const flattened = data.flatMap(lesson => lesson.vocabulary || []);
      ...
      <div className="p-6 border-b border-white/5 bg-black/50 backdrop-blur-md sticky top-0 z-20">
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full bg-gray-900 border border-white/5 py-4 pl-12 pr-6 rounded-2xl outline-none focus:border-cyan-500/50 transition-all font-medium"
          />
        </div>
      </div>
            ...
            >
              <div className="flex-1">
                <div className="flex items-baseline gap-3 mb-1">
                  <h3 className="text-xl font-bold text-white">{word.khmer}</h3>
