...
export default function LessonPreview() {
  ...
  return (
    // ГЛАВНЫЙ ФОН (Весь экран черный)
    <div className="min-h-screen bg-black text-white font-sans flex justify-center">

      {/* КОНТЕЙНЕР (Ограничиваем ширину и центруем) */}
      <div className="w-full max-w-lg relative flex flex-col h-screen shadow-2xl shadow-white/5 bg-black border-x border-white/5">
        ...
        <div className="sticky top-0 z-20 bg-black/80 backdrop-blur-md border-b border-white/10 p-6 flex items-center justify-between">
          ...
          <button
            ...
            className="p-3 bg-gray-900 rounded-full text-gray-400 hover:text-white transition-colors border border-white/5 active:scale-95"
          >
            <X size={24} />
          </button>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-10 h-10 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-500 group-hover:bg-cyan-500 group-hover:text-black transition-all border border-cyan-500/20">
                      <Volume2 size={18} />
                    </div>
                  </div>
                </div>
