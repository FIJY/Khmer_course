...
import {
  ...
  AlertCircle, Trophy, BookOpen, ChevronLeft // <--- Добавили иконку ChevronLeft
} from 'lucide-react';
...
export default function LessonPlayer() {
  ...
  const handleNext = async (quality = 3) => {
    ...
    // SRS логика (только если идем вперед)
                     ...
                     return (
                       <button key={i} disabled={!!selectedOption}
                         onClick={() => {
                            ...
                            if (wordAudio) playAudio(wordAudio);
                            setTimeout(() => {
