      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <section className="rounded-[2rem] border border-white/10 bg-gray-900 p-6">
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-xs text-gray-400">
                Pick a word from the text input to analyze its characters. Click play to hear the
          ...
          {words.length > 0 ? (
              ...
              {words.map((word) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-full px-4 py-1 text-xs font-bold uppercase transition ${
                      isActive
            ...
            <p className="mt-4 text-xs text-gray-500">Type Khmer text above to see word options.</p>
          )}
