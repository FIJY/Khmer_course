    ...
    case 'rule':
      return (
        <div className="w-full flex-1 flex">
          <div className="w-full flex-1 bg-gray-900 border border-white/10 p-6 md:p-8 rounded-[3.5rem] text-center animate-in fade-in slide-in-from-bottom-8 duration-700">
